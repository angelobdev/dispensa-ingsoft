...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/pattern/chain-of-responsability/cor-struttura.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/pattern/chain-of-responsability/cor-sequence.png}
