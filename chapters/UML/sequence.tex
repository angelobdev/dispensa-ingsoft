...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/UML/sequence/sequence-1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/UML/sequence/sequence-2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/UML/sequence/sequence-3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/UML/sequence/sequence-4.png}
